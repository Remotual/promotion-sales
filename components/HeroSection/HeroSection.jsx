        ...
        <div className='bg-[#FFF7F0] w-full pb-[60px]'>
            <div className='w-11/12 m-auto'>
                <div className='m-auto md:w-[62%] w-full pt-[63px] pb-[37px]'>
                    <div className='m-auto md:text-[45px] text-[34px] font-semibold text-center leading-[49.5px]'>{dataJson.salesPage.heroLine}</div>
                </div>
                        ...
                        {
                            {
                                  ...
                                  'tab4': <><Image src={dataJson.salesPage.features.tab4.illustration} height={500} width={500} alt='gif'></Image></>,
                                  ...
                                  'tab8': <><Image src={dataJson.salesPage.features.tab8.illustration} width={1000} height={400} alt='gif'></Image></>,
                            }[tabValue]
                        }
                    </div>
